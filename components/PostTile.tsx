...
export default function PostTile({ slug, metadata }: PostTileProps) {
  ...
  return (
    <Link href={`/posts/${slug}`}>
      <div className="bg-white rounded-lg shadow-sm hover:shadow-md transition-all duration-300 p-4 border border-[#E2E8F0] hover:border-[#629C77] cursor-pointer w-[240px] h-[168px] flex flex-col">
