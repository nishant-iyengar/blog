module.exports = [
"[project]/node_modules/.pnpm/@tensorflow+tfjs-backend-webgl@4.22.0_@tensorflow+tfjs-core@4.22.0/node_modules/@tensorflow/tfjs-backend-webgl/dist/shader_compiler.js [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
;
const { getBroadcastDims } = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f40$tensorflow$2b$tfjs$2d$core$40$4$2e$22$2e$0$2f$node_modules$2f40$tensorflow$2f$tfjs$2d$core$2f$dist$2f$backends$2f$backend_util$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__backend_util$3e$__["backend_util"];
;
;
function makeShader(inputsInfo, outputShape, program) {
    const prefixSnippets = [];
    inputsInfo.forEach((x)=>{
        const size = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f40$tensorflow$2b$tfjs$2d$core$40$4$2e$22$2e$0$2f$node_modules$2f40$tensorflow$2f$tfjs$2d$core$2f$dist$2f$util$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__util$3e$__["util"].sizeFromShape(x.shapeInfo.logicalShape);
...
function getOutput3DCoords(shape, texShape, enableShapeUniforms) {
    if (enableShapeUniforms) {
        const coordsFromIndexSnippet = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f40$tensorflow$2b$tfjs$2d$backend$2d$webgl$40$4$2e$22$2e$0_$40$tensorflow$2b$tfjs$2d$core$40$4$2e$22$2e$0$2f$node_modules$2f40$tensorflow$2f$tfjs$2d$backend$2d$webgl$2f$dist$2f$shader_compiler_util$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getOutputLogicalCoordinatesFromFlatIndexByUniform"]([
            'r',
            'c',
            'd'
        ], shape);
...
`;
    ...
    const coordsFromIndexSnippet = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f40$tensorflow$2b$tfjs$2d$backend$2d$webgl$40$4$2e$22$2e$0_$40$tensorflow$2b$tfjs$2d$core$40$4$2e$22$2e$0$2f$node_modules$2f40$tensorflow$2f$tfjs$2d$backend$2d$webgl$2f$dist$2f$shader_compiler_util$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getLogicalCoordinatesFromFlatIndex"]([
        'r',
        'c',
        'd'
    ], shape);
...
function getOutputPacked2DCoords(shape, texShape, enableShapeUniforms) {
    ...
    if (__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f40$tensorflow$2b$tfjs$2d$core$40$4$2e$22$2e$0$2f$node_modules$2f40$tensorflow$2f$tfjs$2d$core$2f$dist$2f$util$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__util$3e$__["util"].arraysEqual(shape, texShape)) {
        if (enableShapeUniforms) {
            return `
...
function getPackedSampler2D(inputInfo, enableShapeUniforms) {
    ...
    const glsl = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f40$tensorflow$2b$tfjs$2d$backend$2d$webgl$40$4$2e$22$2e$0_$40$tensorflow$2b$tfjs$2d$core$40$4$2e$22$2e$0$2f$node_modules$2f40$tensorflow$2f$tfjs$2d$backend$2d$webgl$2f$dist$2f$glsl_version$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getGlslDifferences"])();
    if (texShape != null && __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f40$tensorflow$2b$tfjs$2d$core$40$4$2e$22$2e$0$2f$node_modules$2f40$tensorflow$2f$tfjs$2d$core$2f$dist$2f$util$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__util$3e$__["util"].arraysEqual(shape, texShape)) {
        if (enableShapeUniforms) {
            return `
...
function getSampler2D(inputInfo, enableShapeUniforms) {
  ...
  `;
    ...
    const { newShape, keptDims } = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f40$tensorflow$2b$tfjs$2d$core$40$4$2e$22$2e$0$2f$node_modules$2f40$tensorflow$2f$tfjs$2d$core$2f$dist$2f$util$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__util$3e$__["util"].squeezeShape(shape);
...
function getUniformSampler(inputInfo) {
    const texName = inputInfo.name;
    const inSize = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f40$tensorflow$2b$tfjs$2d$core$40$4$2e$22$2e$0$2f$node_modules$2f40$tensorflow$2f$tfjs$2d$core$2f$dist$2f$util$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__util$3e$__["util"].sizeFromShape(inputInfo.shapeInfo.logicalShape);
    if (inSize < 2) {
...
function getPackedSamplerAtOutputCoords(inputInfo, outShapeInfo) {
    ...
    const outSize = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f40$tensorflow$2b$tfjs$2d$core$40$4$2e$22$2e$0$2f$node_modules$2f40$tensorflow$2f$tfjs$2d$core$2f$dist$2f$util$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__util$3e$__["util"].sizeFromShape(outShapeInfo.logicalShape);
...
function getUniformInfoFromShape(isPacked, shape, texShape) {
    ...
    const useSqueezeShape = !isPacked && rank > 1 && !__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f40$tensorflow$2b$tfjs$2d$core$40$4$2e$22$2e$0$2f$node_modules$2f40$tensorflow$2f$tfjs$2d$core$2f$dist$2f$util$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__util$3e$__["util"].arraysEqual(shape, texShape) && newShape.length < rank || useSqueezePackedShape;
...
//# sourceMappingURL=11219_%40tensorflow_tfjs-backend-webgl_dist_shader_compiler_821639c2.js.map