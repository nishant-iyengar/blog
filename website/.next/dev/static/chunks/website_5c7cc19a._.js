...
"[project]/website/app/games/tank-trouble/ai-tank/rl-actions.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function actionToDecision(action, currentAngle) {
    ...
    if (typeof action !== 'number') {
        return {
            angleDelta: action.angleDelta * __TURBOPACK__imported__module__$5b$project$5d2f$website$2f$app$2f$games$2f$tank$2d$trouble$2f$config$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ROTATION_SPEED"],
    ...
    const discreteAction = (0, __TURBOPACK__imported__module__$5b$project$5d2f$website$2f$lib$2f$type$2d$guards$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["assertType"])(action, (val)=>typeof val === 'number' && val >= 0 && val < NUM_DISCRETE_ACTIONS, `Invalid discrete action: ${action}`);
    let angleDelta = 0;
    let moveDirection = 0;
    ...
    switch(discreteAction){
        case 0:
            break;
        case 1:
            angleDelta = -__TURBOPACK__imported__module__$5b$project$5d2f$website$2f$app$2f$games$2f$tank$2d$trouble$2f$config$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ROTATION_SPEED"];
            break;
        case 2:
            angleDelta = __TURBOPACK__imported__module__$5b$project$5d2f$website$2f$app$2f$games$2f$tank$2d$trouble$2f$config$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ROTATION_SPEED"];
            break;
...
function decisionToAction(decision) {
    ...
    if (hasRotation && hasMovement && hasShoot) {
        ...
        return {
            type: 'continuous',
            value: {
                angleDelta: decision.angleDelta / __TURBOPACK__imported__module__$5b$project$5d2f$website$2f$app$2f$games$2f$tank$2d$trouble$2f$config$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ROTATION_SPEED"],
...
var __TURBOPACK__imported__module__$5b$project$5d2f$website$2f$app$2f$games$2f$tank$2d$trouble$2f$ai$2d$tank$2f$rl$2d$actions$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/website/app/games/tank-trouble/ai-tank/rl-actions.ts [app-client] (ecmascript)");
;
class RuleBasedRLModel {
    ...
    getInfo() {
        return {
            ...
            actionSize: __TURBOPACK__imported__module__$5b$project$5d2f$website$2f$app$2f$games$2f$tank$2d$trouble$2f$ai$2d$tank$2f$rl$2d$actions$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["NUM_DISCRETE_ACTIONS"]
        };
    }
}
...
;
;
function updateAITank(params, aiConfig = __TURBOPACK__imported__module__$5b$project$5d2f$website$2f$app$2f$games$2f$tank$2d$trouble$2f$ai$2d$tank$2f$config$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["DEFAULT_AI_CONFIG"], trainingManager, gameId) {
    ...
    // Get AI decision
    const decision = (0, __TURBOPACK__imported__module__$5b$project$5d2f$website$2f$app$2f$games$2f$tank$2d$trouble$2f$ai$2d$tank$2f$controller$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["makeAIDecision"])(context);
...
function useMultiGameLogic({ mapData, barriers, suns, aiConfig, trainingManager, maxEpisodeTimeMs = __TURBOPACK__imported__module__$5b$project$5d2f$website$2f$app$2f$games$2f$tank$2d$trouble$2f$constants$2f$game$2d$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["MAX_EPISODE_TIME_MS"], gameInstances, onTanksUpdate, onBulletsUpdate, onLastShotTimesUpdate, onGameOver }) {
    ...
    const gameTick = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$1$2e$0_$40$babel$2b$core$40$7$2e$28$2e$5_react$2d$dom$40$19$2e$2$2e$3_react$40$19$2e$2$2e$3_$5f$react$40$19$2e$2$2e$3$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "useMultiGameLogic.useCallback[gameTick]": (options)=>{
            ...
            gamesToTick.forEach({
                "useMultiGameLogic.useCallback[gameTick]": (instance)=>{
                    // Skip if paused
                    ...
                    if (currentTanks[0]?.lives > 0) {
                        ...
                        if (instance.gameMode === 'person-vs-ai') {
                            ...
                            result = (0, __TURBOPACK__imported__module__$5b$project$5d2f$website$2f$app$2f$games$2f$tank$2d$trouble$2f$ai$2d$tank$2f$index$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["updateAITank"])({
                                tank: currentTanks[0],
                                tankIndex: 0,
                                keys,
                                tickTime,
                    ...
                    if (currentTanks[1]?.lives > 0) {
                        ...
                        const result = (0, __TURBOPACK__imported__module__$5b$project$5d2f$website$2f$app$2f$games$2f$tank$2d$trouble$2f$ai$2d$tank$2f$index$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["updateAITank"])({
                            tank: currentTanks[1],
                            tankIndex: 1,
                            keys,
                            tickTime,
...
class DQNAgent {
   ...
   */ async predict(observation, currentAngle) {
        ...
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$website$2f$app$2f$games$2f$tank$2d$trouble$2f$ai$2d$tank$2f$rl$2d$actions$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["actionToDecision"])(action, currentAngle);
    }
    /**
...
function UnifiedTrainingView() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$1$2e$0_$40$babel$2b$core$40$7$2e$28$2e$5_react$2d$dom$40$19$2e$2$2e$3_react$40$19$2e$2$2e$3_$5f$react$40$19$2e$2$2e$3$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "UnifiedTrainingView.useEffect": ()=>{
            ...
            const gameLoop = {
                "UnifiedTrainingView.useEffect.gameLoop": (currentTime)=>{
                    // Tick all games (all games are always active)
                    gameInstances.forEach({
                        "UnifiedTrainingView.useEffect.gameLoop": (instance, idx)=>{
...
function PlayYourAI({ onBack }) {
    ...
    // Load saved models
    const loadSavedModels = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$1$2e$0_$40$babel$2b$core$40$7$2e$28$2e$5_react$2d$dom$40$19$2e$2$2e$3_react$40$19$2e$2$2e$3_$5f$react$40$19$2e$2$2e$3$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "PlayYourAI.useCallback[loadSavedModels]": async ()=>{
            setIsLoadingModels(true);
            try {
                const models = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$website$2f$app$2f$games$2f$tank$2d$trouble$2f$ai$2d$tank$2f$rl$2d$model$2d$storage$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["listSavedModels"])();
                setSavedModels(models);
    ...
    }["PlayYourAI.useCallback[loadSavedModels]"], []);
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$1$2e$0_$40$babel$2b$core$40$7$2e$28$2e$5_react$2d$dom$40$19$2e$2$2e$3_react$40$19$2e$2$2e$3_$5f$react$40$19$2e$2$2e$3$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$1$2e$0_$40$babel$2b$core$40$7$2e$28$2e$5_react$2d$dom$40$19$2e$2$2e$3_react$40$19$2e$2$2e$3_$5f$react$40$19$2e$2$2e$3$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "PlayYourAI.useEffect": ()=>{
            ...
            const loadModel = {
                "PlayYourAI.useEffect.loadModel": async ()=>{
                    try {
                        await __TURBOPACK__imported__module__$5b$project$5d2f$website$2f$app$2f$games$2f$tank$2d$trouble$2f$ai$2d$tank$2f$rl$2d$model$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["rlModelManager"].loadModel(selectedModel);
            ...
            }["PlayYourAI.useEffect.loadModel"];
            loadModel();
        }
    }["PlayYourAI.useEffect"], [
        selectedModel
...
_s(PlayYourAI, "s9Fi2ibeX0J0WMY9aybPMGgvcPU=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$website$2f$app$2f$games$2f$tank$2d$trouble$2f$hooks$2f$useTankImages$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useTankImages"],
        __TURBOPACK__imported__module__$5b$project$5d2f$website$2f$app$2f$games$2f$tank$2d$trouble$2f$hooks$2f$useGameInput$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useGameInput"],
        __TURBOPACK__imported__module__$5b$project$5d2f$website$2f$app$2f$games$2f$tank$2d$trouble$2f$components$2f$GameLogic$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMultiGameLogic"]
...
_s(GamesPage, "yndtVspVW7J16quWcL+peBepiZA=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$1$2e$0_$40$babel$2b$core$40$7$2e$28$2e$5_react$2d$dom$40$19$2e$2$2e$3_react$40$19$2e$2$2e$3_$5f$react$40$19$2e$2$2e$3$2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRouter"]
    ];
});
...
//# sourceMappingURL=website_5c7cc19a._.js.map